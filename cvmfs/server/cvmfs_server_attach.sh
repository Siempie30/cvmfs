...
# This script takes care of adding an existing repository on an S3 backend to this machine
#
# Implementation of the "cvmfs_server attach" command
...
cvmfs_server_attach() {
  ...
  if [ x"$upstream_type" != xgw ]; then
      ...
      # Add -E for skipping creation of new repository manifest
