...
echo "$OUTPUT"
EXPECTED="http://cvmfs-gw1:4929/api/v1|0|1|1" # Address, status is 0, default is 1, current is 1
...
OUTPUT=$(execute_in_container cvmfs-pub1 "sqlite3 $DB_FILE \"SELECT * FROM gateway;\"")
echo "$OUTPUT"
EXPECTED="http://cvmfs-gw1:4929/api/v1|0|1|1
http://cvmfs-gw2:4929/api/v1|0|0|0"
...
echo "$OUTPUT"
EXPECTED="http://cvmfs-gw1:4929/api/v1|0|1|1
http://cvmfs-gw2:4929/api/v1|3|0|0" # Status is now 3 (down)
